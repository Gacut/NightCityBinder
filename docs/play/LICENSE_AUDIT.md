...
5. Zachować oryginalne copyright, NOTICE i wymagania udostępnienia źródeł dla komponentów, których licencja tego wymaga. Autor wybrał MIT dla własnego kodu i materiałów; zakres opisuje LICENSING.md. Nie przepisywać zbiorczo cudzych komponentów jako MIT.
